...
import { Lock, Mail, Phone, Sparkles, User, ArrowLeft } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const data = await register(email, phone, password, firstName, lastName);
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-950 via-primary-900 to-primary-800 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-slide-in">
          ...
          <p className="text-primary-200">Join our customer portal today</p>
        </div>
        ...
        <div className="glass-card-dark rounded-2xl p-8 shadow-2xl animate-slide-in" style={{ animationDelay: '0.1s' }}>
          <Link
            href="/"
            className="flex items-center text-primary-200 hover:text-white mb-6 text-sm transition-colors"
          >
          ...
          <div className="mt-6 text-center">
            <p className="text-primary-300 text-sm">
              ...
              <Link href="/" className="text-mint-400 hover:text-mint-300 font-medium">
                Sign In
              </Link>
            </p>
          </div>
